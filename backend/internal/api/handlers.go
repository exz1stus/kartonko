...
func WithUser(c *gin.Context, api *api, fn func(*models.User) error) {
...
func WithUserAndQuery[Q any](c *gin.Context, api *api, parseFn func(*gin.Context) (Q, error), fn func(*models.User, Q) error) {
	user, err := api.GetUserFromContext(c)
	if err != nil {
		RespondError(c, wrapUnauthorized(err))
		return
...
func HandleUpload(c *gin.Context, api *api, metadata string, fileHeader *multipart.FileHeader) (*models.ImageMetadata, error) {
...
func HandleBatchUpload(c *gin.Context, api *api, metadata string, form *multipart.Form) (*dto.ImagePostBatchResponse, error) {

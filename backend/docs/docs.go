        ...
        "/board/{id}": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Board patch request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/board/{id}/image": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Board item creation request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/BoardItemPostRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/image": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Interpret prefix as a natural-language semantic query",
                        "name": "semantic",
                        "in": "query"
                    },
                    {
        ...
        "/image/upload/batch": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "example": "{\"data\": [{\"name\": \"img1\", \"tags\": [\"tag1\"]}, {\"name\": \"img2\", \"tags\": [\"tag2\"]}], \"common_tags\": [\"common\"]}",
                        "description": "Batch metadata (JSON)",
                        "name": "metadata",
                        "in": "formData",
                        "required": true
                    },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/TagPostRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/TagPostBatchRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/TagBatchResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",

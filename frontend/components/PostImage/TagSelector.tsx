...
//                         className="bg-blue-200 px-3 py-1 rounded-full text-blue-800 text-sm cursor-pointer"
//                     >
//                         {tag.name} ✕
//                     </span>
//                 ))}
...
//                             key={tag.name}
//                             onClick={() => addTag(tag)}
//                             className="bg-gray-500 hover:bg-gray-300 px-3 py-0 rounded-full text-sm transition"
//                             type="button"
//                             style={{ flex: "none" }}
//                         >
//                             {tag.name}
